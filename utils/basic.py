...
def find_best_alignment(gt_normal, pred_normal):
    """
    Find the best operation to align gt_normal to pred_normal.
    
    Args:
    - gt_normal: Tensor of shape (N, 3), GT normal vectors.
    - pred_normal: Tensor of shape (N, 3), predicted normal vectors.
    
    Returns:
    - best_perm: The best xyz axis permutation (e.g., (0, 1, 2)).
    - best_signs: The best sign adjustments (e.g., [1, -1, 1]).
    - best_error: The minimum error after adjustment.
    """
    # All possible permutations of axis order
    permutations = list(itertools.permutations([0, 1, 2]))
    # All possible sign combinations (+1, -1)
    ...
    for perm in permutations:
        for sign in signs:
            # Adjust the order and signs of gt_normal
